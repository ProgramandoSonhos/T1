    ...
    <section id="exemplo">
        ...
        <fieldset>
          ...
          <p>
            ...
            <label><input type="radio" name="estado-civil" value="radio" id="estado-civil_1">Solteiro </label>
            <label><input type="radio" name="estado-civil" value="radio" id="estado-civil_2">Casado </label>
            </label>
            <br>
          </p>
        </fieldset>
